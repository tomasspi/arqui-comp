...
//    end
    ...
    (
        ...
        .i_pc_salto(pc_salto), .i_pc_src(pc_src), .i_halt(halt),
    ...
    (
        ...
        .o_branch(branch_e), .o_jump(jump_e), .o_mem_read(memrd_e), .o_mem_write(memwr_e), 
        .o_mem_to_reg(memtoreg_e), .o_reg_write(regwr_e), .o_pc_branch(pc_branch), 
        .o_alu_result(aluResult), .o_halt(halt_e),
    ...
    (
        ...
        .i_branch(branch_e), .i_jump(jump_e), .i_mem_read(memrd_e), 
